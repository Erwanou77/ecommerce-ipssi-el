...
--
-- Host: localhost    Database: symfony-ecommerce
-- ------------------------------------------------------
...
CREATE TABLE `carts_products` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_12E5DBFB1AD5CDBF` (`cart_id`),
  KEY `IDX_12E5DBFB4584665A` (`product_id`),
  CONSTRAINT `FK_12E5DBFB1AD5CDBF` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`),
  CONSTRAINT `FK_12E5DBFB4584665A` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
-- Dump completed on 2022-12-17 22:12:59
